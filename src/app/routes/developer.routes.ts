...
export const developerRoutes: Routes = [
    ...
    { path: 'role-activity-mapping', loadComponent: () => import('../components/developer/role-activity-mapping/role-activity-mapping').then(c => c.RoleActivityMapping), title: 'Role Activity Mapping' },
